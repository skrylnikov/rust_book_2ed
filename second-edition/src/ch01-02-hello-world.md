...
Прежде чем выполнить программу (т.е.вызвать в строке терминала созданные файлы
...
компиляции и выполнения программ. В составе утилит Rust есть [Ahead-of-Time] (AOT)
 ...
 программного обеспечения, так и для пользователей. Динамические компилируемые
...
Отличия нашего предыдущего проекта от сгенерированного Cargo следующий:
...
*Cargo.lock*, посмотрите содержание папки *src*.
