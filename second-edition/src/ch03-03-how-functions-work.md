...
Важной особенностью Rust является тот факт, что язык разделяет понятия оператор
и выражение. Последующий материал поможет во всём этом разобраться.
